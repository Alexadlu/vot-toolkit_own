...
class bbox_estimator:
    ...
    def track(self, image_curr, tracknet, velocity, sess):
        ...
        re_fc4_image, fc4_adj = sess.run([tracknet.re_fc4_image, tracknet.fc4_adj], feed_dict={tracknet.image: cur_search_region_expdim,
...
#  descend!
cklist=['/home/jaehyuk/code/github/vot-toolkit/tracker/examples/python/checkpoints/checkpoint.ckpt-58897',
